...
bool operator==(const ::object_recognition_msgs::GetObjectInformationRequest_<ContainerAllocator1> & lhs, const ::object_recognition_msgs::GetObjectInformationRequest_<ContainerAllocator2> & rhs)
{
