...
bool operator==(const ::object_recognition_msgs::ObjectRecognitionAction_<ContainerAllocator1> & lhs, const ::object_recognition_msgs::ObjectRecognitionAction_<ContainerAllocator2> & rhs)
{
