...
bool operator==(const ::object_recognition_msgs::ObjectRecognitionActionResult_<ContainerAllocator1> & lhs, const ::object_recognition_msgs::ObjectRecognitionActionResult_<ContainerAllocator2> & rhs)
{
