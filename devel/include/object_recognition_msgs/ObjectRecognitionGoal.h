...
bool operator==(const ::object_recognition_msgs::ObjectRecognitionGoal_<ContainerAllocator1> & lhs, const ::object_recognition_msgs::ObjectRecognitionGoal_<ContainerAllocator2> & rhs)
{
  return lhs.use_roi == rhs.use_roi &&
