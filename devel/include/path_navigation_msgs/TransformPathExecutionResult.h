...
bool operator==(const ::path_navigation_msgs::TransformPathExecutionResult_<ContainerAllocator1> & lhs, const ::path_navigation_msgs::TransformPathExecutionResult_<ContainerAllocator2> & rhs)
{
