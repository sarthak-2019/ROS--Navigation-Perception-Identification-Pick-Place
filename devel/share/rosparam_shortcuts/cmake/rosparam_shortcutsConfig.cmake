...
if(NOT "/home/sarthak/catkin_ws/src/rosparam_shortcuts/include;/usr/include/eigen3 " STREQUAL " ")
  set(rosparam_shortcuts_INCLUDE_DIRS "")
  set(_include_dirs "/home/sarthak/catkin_ws/src/rosparam_shortcuts/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sarthak/catkin_ws/src/rosparam_shortcuts/${idir}'.  ${_report}")
    endif()
